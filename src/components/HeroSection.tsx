      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
            <span className="block transition-all duration-1000 ease-out translate-y-0 opacity-100" style={{ animationFillMode: 'forwards' }}>Fremad Digitalt</span>
            <span className="block mt-2 transition-all duration-1000 ease-out delay-300 translate-y-0 opacity-100" style={{ animationFillMode: 'forwards' }}>Mennesket først.</span>
          </h1>
          ...
          <p className="text-lg md:text-xl text-white/80 max-w-xl mx-auto mb-8 transition-all duration-1000 ease-out delay-600 translate-y-0 opacity-100" style={{ animationFillMode: 'forwards' }}>
            Vi er et dansk AI-firma, der bygger løsninger med mennesket i centrum.
          </p>
